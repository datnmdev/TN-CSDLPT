 ...
 * @author HP
 */
public class PnlCreateLoginTruong extends javax.swing.JPanel {
     ...
     */
    public PnlCreateLoginTruong() {
        initComponents();
    }

    public PnlCreateLoginTruong(String magv) throws SQLException {
        this.magv = magv;
        initComponents();
    ...
    private void btnCreateLoginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCreateLoginActionPerformed
        try {
            ...
            int result = CreateLoginRepository.createLoginTruong(login, password, magv, rule);
    ...
    private void btnClearLoginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnClearLoginActionPerformed
        try {
            // TODO add your handling code here:
            CreateLoginRepository.clearLoginTruong(loginName, magv);
