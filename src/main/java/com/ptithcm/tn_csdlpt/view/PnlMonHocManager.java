 ...
 * @author MINHDAT
 */
public class PnlMonHocManager extends javax.swing.JPanel {

    private PnlManageBar pnlManageBar;
    private PnlMonHocInfo pnlMonHocInfo;
     ...
     */
    public PnlMonHocManager(String tabName, String groupName) throws IOException {
        initComponents();
    ...
    public void addEvents() {
        ...
        tblData.addMouseListener(new MouseAdapter() {
            public void mouseClicked(MouseEvent e) {
                try {
                    ...
                    Object monhoc = getObjectFromRow(selectedRow);
                    fillStudentField(monhoc);
                } catch (ParseException ex) {
                    Logger.getLogger(PnlMonHocManager.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
        }
        );
        ...
        pnlManageBar.getBtnAdd().addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                ...
                try {
                    ValidateFormService.validateFrmMonInfoAdd(pnlMonHocInfo, objectActions);

                    MonHoc mh = new MonHoc(pnlMonHocInfo.getTxtMaMH().getText(), pnlMonHocInfo.getTxtTenMH().getText());
                    ...
                    //                        Cập nhật lại bảng
                    Object[] row = {mh.getMaMH(), mh.getTenMH()};
        ...
        pnlManageBar.getBtnUpdate().addMouseListener(new MouseAdapter() {
            public void mouseClicked(MouseEvent e) {
                ...
                try {
                    ValidateFormService.validateFrmMonInfoUpdate(pnlMonHocInfo , objectActions, maMon);

                    MonHoc monhoc = new MonHoc(pnlMonHocInfo.getTxtMaMH().getText(), pnlMonHocInfo.getTxtTenMH().getText());
                    int objectActionIndex = -1;
                    for (int i = 0; i < objectActions.size(); ++i) {
                        MonHoc mh = (MonHoc) objectActions.get(i).getObjects().get(0);
                        if (maMon.strip().equals(mh.getMaMH().strip())) {
                            objectActionIndex = i;
                            break;
                        }
                    }
                    if (objectActionIndex != -1) {
                        ...
                        ObjectAction objectAction = new ObjectAction(
                                ...
                                (MonHoc) objectActions.get(objectActionIndex).getObjects().get(0)
                        );
...
//                        Cập nhật dữ liệu cho bảng
                        DefaultTableModel tblDataModel = (DefaultTableModel) tblData.getModel();
                        Object[] row = {monhoc.getMaMH(), monhoc.getTenMH()};
...
//                            Gọi lệnh save từ tầng service
                    MonHocService.saveAll(objectActions);
...
//                            Tiến hành load lại trang sau khi ghi thành công
                    ...
                    //  Load lại dữ liệu
                    MonHocController.renderData(PnlMonHocManager.this);
        ...
        pnlManageBar.getBtnUndo().addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                if (!undoRedo.getUndoStack().isEmpty()) {
                    ...
                    MonHoc monhoc = (MonHoc) objectActionUndo.getObjects().get(0);
                    Object[] row = {
        ...
        pnlManageBar.getBtnRedo().addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                if (!undoRedo.getRedoStack().isEmpty()) {
                    ...
                    MonHoc monhoc = (MonHoc) objectActionRedo.getObjects().get(0);
                    Object[] row = {
                        monhoc.getMaMH(), monhoc.getTenMH()};
...
//    Methods
    public void initMyComponents(String tabName) {
        ...
        pnlDataEntryFormContainer.add((pnlMonHocInfo = new PnlMonHocInfo()));
    ...
    public void fillTableForTeacher(List<ObjectAction> objectActions) {
        ...
        for (ObjectAction objectAction : objectActions) {
            ...
            row.add(((MonHoc) objectAction.getObjects().get(0)).getMaMH());
            row.add(((MonHoc) objectAction.getObjects().get(0)).getTenMH());
    ...
    public void fillStudentField(Object object) {
        ...
        //để có thể thay đổi được mã môn học
        maMon = mh.getMaMH();

        pnlMonHocInfo.getTxtMaMH().setText(mh.getMaMH());
        pnlMonHocInfo.getTxtTenMH().setText(mh.getTenMH());
    }
...
//    Getters and setters
    ...
    public PnlMonHocInfo getPnlMonHocInfo() {
        return pnlMonHocInfo;
    }

    public void setPnlMonHocInfo(PnlMonHocInfo pnlMonHocInfo) {
        this.pnlMonHocInfo = pnlMonHocInfo;
    }
