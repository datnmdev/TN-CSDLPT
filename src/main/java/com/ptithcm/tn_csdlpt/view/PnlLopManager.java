 ...
 * @author MINHDAT
 */
public class PnlLopManager extends javax.swing.JPanel {

    private PnlManageBar pnlManageBar;
    private PnlLopInfo pnlLopInfo;
     ...
     */
    public PnlLopManager(String tabName, String groupName, String maKhoa) throws IOException {
        initComponents();
        initMyComponents(tabName, maKhoa);
    ...
    public void addEvents() {
        ...
        tblData.addMouseListener(new MouseAdapter() {
            public void mouseClicked(MouseEvent e) {
                try {
                    ...
                    Logger.getLogger(PnlLopManager.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
        }
        );
        ...
        pnlManageBar.getBtnAdd().addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                ...
                try {
                    ValidateFormService.validateFrmLopInfoAdd(pnlLopInfo, objectActions);

                    Lop mh = new Lop(pnlLopInfo.getTxtMaMH().getText(), pnlLopInfo.getTxtTenMH().getText(), maKhoa);
                    ...
                    //                        Cập nhật lại bảng
                    Object[] row = {mh.getMaLop(), mh.getTenLop(), mh.getMaKH()};
        ...
        pnlManageBar.getBtnUpdate().addMouseListener(new MouseAdapter() {
            public void mouseClicked(MouseEvent e) {
                ...
                try {
                    ValidateFormService.validateFrmLopInfoUpdate(pnlLopInfo, maLop);

                    Lop lop = new Lop(pnlLopInfo.getTxtMaMH().getText(), pnlLopInfo.getTxtTenMH().getText(), maKhoa);
                    int objectActionIndex = -1;
                    for (int i = 0; i < objectActions.size(); ++i) {
                        Lop l = (Lop) objectActions.get(i).getObjects().get(0);
                        if (maLop.strip().equals(l.getMaLop().strip())) {
                            objectActionIndex = i;
                            break;
                        }
                    }
                    ...
                    if (objectActionIndex != -1) {
                        ...
                        ObjectAction objectAction = new ObjectAction(
                                ...
                                (Lop) objectActions.get(objectActionIndex).getObjects().get(0)
                        );
...
//                        Cập nhật dữ liệu cho bảng
                        DefaultTableModel tblDataModel = (DefaultTableModel) tblData.getModel();
                        Object[] row = {lop.getMaLop(), lop.getTenLop(), lop.getMaKH()};
...
//        Xử lý sự kiện nút delete        
        pnlManageBar.getBtnDelete().addMouseListener(new MouseAdapter() {
            public void mouseClicked(MouseEvent e) {
                ...
                Lop monhoc = new Lop(pnlLopInfo.getTxtMaMH().getText(), pnlLopInfo.getTxtTenMH().getText(), maKhoa);
                int objectActionIndex = -1;
                for (int i = 0; i < objectActions.size(); ++i) {
                    Lop mh = (Lop) objectActions.get(i).getObjects().get(0);
                    if (maLop.strip().equals(mh.getMaLop().strip())) {
                        objectActionIndex = i;
                        break;
                    }
                }
...
//                            Gọi lệnh save từ tầng service
                    LopService.saveAll(objectActions);
...
//                            Tiến hành load lại trang sau khi ghi thành công
                    ...
                    //  Load lại dữ liệu
                    LopController.renderData(PnlLopManager.this, maKhoa);
        ...
        pnlManageBar.getBtnUndo().addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                if (!undoRedo.getUndoStack().isEmpty()) {
                    ...
                    Lop monhoc = (Lop) objectActionUndo.getObjects().get(0);
                    Object[] row = {
                        monhoc.getMaLop(), monhoc.getTenLop(), monhoc.getMaKH()};
        ...
        pnlManageBar.getBtnRedo().addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                if (!undoRedo.getRedoStack().isEmpty()) {
                    ...
                    Lop monhoc = (Lop) objectActionRedo.getObjects().get(0);
                    Object[] row = {
                        monhoc.getMaLop(), monhoc.getTenLop(), monhoc.getMaKH()};
...
//    Methods
    public void initMyComponents(String tabName, String maKhoa) {
        this.maKhoa = maKhoa;
        this.tabName = tabName;
        pnlManageBarContainer.add((pnlManageBar = new PnlManageBar()));
        pnlDataEntryFormContainer.add((pnlLopInfo = new PnlLopInfo()));
    ...
    public void fillTableForTeacher(List<ObjectAction> objectActions) {
        ...
        for (ObjectAction objectAction : objectActions) {
            ...
            row.add(((Lop) objectAction.getObjects().get(0)).getMaLop());
            row.add(((Lop) objectAction.getObjects().get(0)).getTenLop());
            row.add(((Lop) objectAction.getObjects().get(0)).getMaKH());
    ...
    public void fillStudentField(Object object) {
        Lop lop = (Lop) object;
        maLop = lop.getMaLop();
        pnlLopInfo.getTxtMaMH().setText(lop.getMaLop());
        pnlLopInfo.getTxtTenMH().setText(lop.getTenLop());
    }
...
//    Getters and setters
    ...
    public PnlLopInfo getPnlLopInfo() {
        return pnlLopInfo;
    }

    public void setPnlLopInfo(PnlLopInfo pnlLopInfo) {
        this.pnlLopInfo = pnlLopInfo;
    }
