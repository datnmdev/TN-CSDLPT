 ...
 * @author MINHDAT
 */
public class PnlStudentManager extends javax.swing.JPanel {

    private PnlManageBar pnlManageBar;
    private PnlStudentInfo pnlStudentInfo;
     ...
     */
    public PnlStudentManager(String tabName, String groupName) throws IOException {
        initComponents();
        ...
        tblData.addMouseListener(new MouseAdapter() {
            public void mouseClicked(MouseEvent e) {
                try {
                    ...
                    Object student = getObjectFromRow(selectedRow);
                    fillStudentField(student);
            ...
            public void mouseClicked(MouseEvent e) {
                try {
                    ...
                    ObjectAction objectAction = new ObjectAction(
                            ...
                            tblDataModel.getRowCount(), sv);

//                        Thêm đối tượng vào objectActions
                    objectActions.add(objectAction);

//                        Cập nhật lại bảng
                    Object[] row = {sv.getMaSV(), sv.getHo(), sv.getTen(), sv.getNgaySinhStr(), sv.getDiaChi(), sv.getMaLop()};
            ...
            public void mouseClicked(MouseEvent e) {
                try {
                    ...
                    for (int i = 0; i < objectActions.size(); ++i) {
                        ...
                        if (masv.strip().equals(sv.getMaSV().strip())) {
                            objectActionIndex = i;
                            break;
                        }
                    }
                    ...
                    if (objectActionIndex != -1) {
                        ...
                        ObjectAction objectAction = new ObjectAction(
                                ...
                                (SinhVien) objectActions.get(objectActionIndex).getObjects().get(0)
                        );
...
//                        Cập nhật dữ liệu cho bảng
                        ...
                        System.out.println(selectedRowIndex + "   ádfasdfmlsmflkm");
                ...
                try {
                    ...
                    if (objectActionIndex != -1) {
                        ...
                        ObjectAction objectAction = new ObjectAction(
                                ...
                                objectActionIndex, selectedRowIndex, student
                        );
...
//                            Gọi lệnh save từ tầng service
                    SinhVienService.saveAll(objectActions);
...
//                            Tiến hành load lại trang sau khi ghi thành công
                    ...
                    //  Load lại dữ liệu
                    SinhVienController.renderData(PnlStudentManager.this);
...
//    Methods
    public void initMyComponents(String tabName) {
        ...
        pnlDataEntryFormContainer.add((pnlStudentInfo = new PnlStudentInfo()));
    ...
    public void fillTableForTeacher(List<ObjectAction> objectActions) {
        ...
        for (ObjectAction objectAction : objectActions) {
            ...
            row.add(((SinhVien) objectAction.getObjects().get(0)).getMaSV());
            row.add(((SinhVien) objectAction.getObjects().get(0)).getHo());
            row.add(((SinhVien) objectAction.getObjects().get(0)).getTen());
            row.add(((SinhVien) objectAction.getObjects().get(0)).getNgaySinhStr());
            row.add(((SinhVien) objectAction.getObjects().get(0)).getDiaChi());
            row.add(((SinhVien) objectAction.getObjects().get(0)).getMaLop());
    ...
    public void fillStudentField(Object object) {
        ...
        pnlStudentInfo.getTxtDiaChi().setText(student.getDiaChi());
        pnlStudentInfo.getTxtNgaySinh().setText(student.getNgaySinhStr());
        pnlStudentInfo.setSelectedKhoaItem(student.getMaLop());
    }
...
//    Getters and setters
    ...
    public PnlStudentInfo getPnlStudentInfo() {
        return pnlStudentInfo;
    }

    public void setPnlStudentInfo(PnlStudentInfo pnlStudentInfo) {
